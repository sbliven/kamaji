...
def main(argv=None):
    ...
    parser.add_argument('dst', metavar='dst', default=None,
    ...
    parser.add_argument('-v','--verbose',default=logging.WARN,action='store_const',dest='logLevel',const=logging.DEBUG)

    args = parser.parse_args(argv)

    logging.basicConfig(level=args.logLevel)#, format="%(message)s")

    sorter = PhotoSorter(recursive=args.recursive,
