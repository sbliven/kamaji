...
for line in open('postfslint/__init__.py'):
...
setup(
    ...
    description='Post-processing of fslint files',

    # The project's main homepage.
    url='https://github.com/sbliven/postfslint',
    ...
    keywords='duplicates utility deduplication',
